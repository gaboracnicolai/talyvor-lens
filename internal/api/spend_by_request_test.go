...
func spendHarness(t *testing.T) *Server {
	...
	// The harness table predates 0099 in long-lived test databases — align it.
...
// (e) CACHE-SERVE VISIBILITY (0099): every row carries serve_source so the dashboard can compute
